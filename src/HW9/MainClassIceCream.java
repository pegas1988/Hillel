...
public class MainClassIceCream {
    public static void main(String[] args) {
        IceCreamMakerJohny iceCreamMakerJohny = new IceCreamMakerJohny(new PineApple(new BlackBerry(new AppleJuice(null))), fillings.IRISH);
        IceCreamMakerMatilda iceFromMatilda = new IceCreamMakerMatilda(new AppleJuice(new Cherry(null)), fillings.CHOCOLATE);
        IceCreamMakerPatrick iceFromPatrick = new IceCreamMakerPatrick(new Cherry(new Cherry(new PineApple(null))), fillings.HUZZELNUT);
